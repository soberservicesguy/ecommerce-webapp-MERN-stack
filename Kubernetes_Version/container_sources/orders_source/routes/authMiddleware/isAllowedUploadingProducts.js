module.exports.isAllowedUploadingProducts = (req, res, next) => {
    ...
    // check user privilege
        ...
        let required_privilege = req.user.user_object.privileges.filter(
            function(privilege_object){
                return privilege_object.privilege_name === 'is_allowed_product_upload'
            }
        )
        ...
        if (required_privilege){
            ...
            res.status(401).json({ msg: 'isAllowedUploadingProducts Privilege missing' });            
