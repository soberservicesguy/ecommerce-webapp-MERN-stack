module.exports.isAllowedWritingBlogposts = (req, res, next) => {
    ...
    // check user privilege
        ...
        let required_privilege = req.user.user_object.privileges.filter(
            function(privilege_object){
                return privilege_object.privilege_name === 'is_allowed_writing_blopost'
            }
        )
        ...
        if (required_privilege){
            ...
            res.status(401).json({ msg: 'isAllowedWritingBlogposts Privilege missing' });            
