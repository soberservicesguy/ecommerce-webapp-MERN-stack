...
ProductCollection.
	...
	exec(function (err, productcollections) {
	    ...
	    console.log('productcollection is %s', productcollections)});// showing product and populating children
...
Product.
	...
	exec(function (err, products) {
	    ...
	    console.log('product is %s', products)});// showing order and populating children
...
Order.
	...
	exec(function (err, orders) {
	    ...
	    console.log('order is %s', orders)		// console.log('The users %s', order.users);
...
BlogPost.
	...
	exec(function (err, blogposts) {
	    ...
	    console.log('blogpost is %s', blogposts)});